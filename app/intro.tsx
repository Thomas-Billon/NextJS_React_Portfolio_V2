...
const Intro = (): React.ReactNode => {
    return(
        <section id="intro">
            ...
            <IntroHeadline className="z-30" classNameHeadline="intro-headline-text-full" classNameSubline="intro-subline-text-hidden" dataNoSnippet={true} isTextGlitched={true}/>
